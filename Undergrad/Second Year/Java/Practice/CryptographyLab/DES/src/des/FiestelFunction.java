...
public class FiestelFunction {
	...
	public static int[] fFunction(int[] argument32Bits, int[] argument48Bits) 
	{
		...
		// compute expanded argument XOR and argument48Bits as a concatenation of 
		// 6x 8bitstrings
		int computeResult[] = Utility.xorFunction(expandedArgument, argument48Bits);	

		 // The S boxes are applied to result and, the final result is permuted 
		 // according to P permutation
	...
	public static int[] sBoxes(int[] bitstring)
	{
		...
		// Use P Permutation to find 8 x finalResult of length 32
