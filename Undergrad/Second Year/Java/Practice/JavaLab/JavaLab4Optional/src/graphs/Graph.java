...
public class Graph implements Serializable {
	...
	public Graph(String name, String description, String definitionPath, String imagePath) throws InvalidImageFormat, InvalidGraphFormat
	{
		this.name = name;
		this.definition = definitionPath;
		this.image = imagePath;

		if (!checkValidGraphFormat(definitionPath))
			throw new InvalidGraphFormat("Invalid graph format");

		if (!checkValidImageFormat(imagePath))
	...
	{
		return this.name + ": " + this.definition + ", " + this.image;
	}
}
